---
description: Replace one Shunt OPERATOR entry by id or by a unique old_text match
argument-hint: "<entry-id or old text> -> <new text>"
---

Use the shunt file-memory skill. Run `memory replace --root "$PWD" --target operator`
